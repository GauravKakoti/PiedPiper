...
/// if none are picked, default to UI selects
...
/// This encodes the parameters for the embed subcommand
/// All values are optional, and will substituted in using UI if missing.
...
pub struct EmbedParams {
    ...
    /// More specific encoding options override present options.
    #[arg(short, long)]
    pub preset: Option<EmbedPreset>,

    /// Etching mode to use for encoding
    #[arg(long)]
    ...
    /// Must be of "144", "240", "360", `480", "720",
...
pub enum EmbedPreset {
    /// optional compression resistance
    Optimal,
